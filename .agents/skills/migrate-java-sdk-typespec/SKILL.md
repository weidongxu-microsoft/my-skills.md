---
name: migrate-java-sdk-typespec
description: '**WORKFLOW SKILL** - Update Java SDK and TypeSpec project, regenerate the SDK, and fix SDK project errors. USE FOR: "migrate sdk lib for <tsp-project>".'
---
