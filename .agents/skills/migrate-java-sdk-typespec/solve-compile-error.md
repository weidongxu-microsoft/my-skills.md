...
Usually this is due to the class was a subclass of `Resource`, but now becomes a subclass of another class that does not inherit `Resource`.
...
3. If not, you should pause the procedure, and report this case to user for further decision.
